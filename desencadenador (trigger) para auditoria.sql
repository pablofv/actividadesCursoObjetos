    ...
    if inserting then -- Estoy haciendo un insert
        ...
        for i in 1..var_columnas.count loop
            if updating(var_columnas(i).column_name) then
                insert into audit_documento_exp(ID_AUDIT_DOCUMENTO_EXP, FECHAHORA, TABLADESDE, CAMPOMODIFICADO, TIPOACCION,
                                                                                                    ID_DOCUMENTO_EXP,
                                                                                                    ID_EXPEDIENTE,
                                                                                                    ID_MODELO,
                                                                                                    ID_FIRMANTE,
                                                                                                    ...
                                                                                                    FECHA_INHIBICION,
                                                                                                    CONTENT_TYPE
                ) select S_AUDIT_DOCUMENTO_EXP.nextval, systimestamp, var_columnas(i).table_name, var_columnas(i).column_name, 'ACTUALIZACIÓN_ANTES', :old.ID_DOCUMENTO_EXP,
                                                                                                                                            :old.ID_EXPEDIENTE,
                                                                                                                                            :old.ID_MODELO,
                                                                                                                                            :old.ID_FIRMANTE,
                                                                                                                                            :old.ID_DOCUMENTO_RELACIONADO,
                                                                                                                                            :old.ID_CEDULA_EXP,
                                                                                                                                            :old.ID_DOCUMENTO_BANDEJA,
                                                                                                                                            :old.DESCRIPCION,
                                                                                                                                            :old.ORDEN,
                                                                                                                                            :old.FIRMA,
                                                                                                                                            :old.FECHA_FIRMA,
                                                                                                                                            ...
                                                                                                                                            :old.TIPO_RESOLUCION,
                                                                                                                                            :old.CERT_PRUEBA,
                                                                                                                                            :old.CERT_PRUEBA_DESCRIPCION,
                                                                                                                                            :old.TESTIMONIO,
                                                                                                                                            :old.ID_DOCUMENT_STORE,
                                                                                                                                            :old.STATUS,
                                                                                                                                            :old.UUID,
                                                                                                                                            :old.OBSERVACIONES_RES_RECURSO,
                                                                                                                                            :old.TIPO_VOTO_RES_RECURSO,
                                                                                                                                            :old.TIPO_RES_RECURSO,
                                                                                                                                            :old.FOJA_VUELTA,
                                                                                                                                            :old.ID_OFICINA,
                                                                                                                                            :old.ID_DOCUMENTO_ORIGEN,
                                                                                                                                            :old.EVENTOS,
                                                                                                                                            :old.ID_FIRMANTE_2,
                                                                                                                                            :old.INCORPORADO,
                                                                                                                                            :old.ID_ESTADO_EXPEDIENTE,
                                                                                                                                            :old.ID_EXPEDIENTE_ORIGEN,
                                                                                                                                            :old.ID_EXPEDIENTE_FUSION,
                                                                                                                                            :old.ID_CAMARA,
                                                                                                                                            :old.ID_DOCUMENTO_EXP_TMP,
                                                                                                                                            :old.ID_CEDULA_EXP_TMP,
                                                                                                                                            :old.ID_DOCUMENTO_BANDEJA_TMP,
                                                                                                                                            :old.ID_DOCUMENTO_REL_TMP,
                                                                                                                                            :old.SENTENCIA,
                                                                                                                                            :old.ID_RECURSO_EXP,
                                                                                                                                            :old.TIPO_PROYECTO,
                                                                                                                                            :old.TIMESTAMP_MODIFICACION,
                                                                                                                                            :old.USUARIO_MODIFICACION,
                                                                                                                                            :old.TICKET_DESPACHO_AVANZADO,
                                                                                                                                            :old.FECHA_ESTADO_DOCUMENTO,
                                                                                                                                            :old.INHIBIDO,
                                                                                                                                            :old.USUARIO_INHIBICION,
                                                                                                                                            :old.CREADO_MASIVO,
                                                                                                                                            :old.ID_SUBTIPO_FALLO,
                                                                                                                                            :old.CIERRA_RECURSO,
                                                                                                                                            :old.DIGITAL,
                                                                                                                                            :old.VERSION,
                                                                                                                                            :old.DESPACHO_DESDE_PDF,
                                                                                                                                            :old.ID_ESTADO_DOCUMENTO,
                                                                                                                                            :old.FECHA_INHIBICION,
                                                                                                                                            :old.CONTENT_TYPE
                  from dual;
                insert into audit_documento_exp(ID_AUDIT_DOCUMENTO_EXP, FECHAHORA, TABLADESDE, CAMPOMODIFICADO, TIPOACCION,
                                                                                                    ID_DOCUMENTO_EXP,
                                                                                                    ...
                                                                                                    FECHA_INHIBICION,
                                                                                                    CONTENT_TYPE)
                  select S_AUDIT_DOCUMENTO_EXP.nextval, systimestamp, var_columnas(i).table_name, var_columnas(i).column_name, 'ACTUALIZACIÓN_DESPUÉS', :new.ID_DOCUMENTO_EXP,
                                                                                                                                            :new.ID_EXPEDIENTE,
                                                                                                                                            :new.ID_MODELO,
                                                                                                                                            :new.ID_FIRMANTE,
