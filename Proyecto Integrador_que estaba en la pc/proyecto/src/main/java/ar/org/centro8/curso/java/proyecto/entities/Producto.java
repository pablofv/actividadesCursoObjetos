...
public class Producto {
    ...
    public Producto(String nombre, String marca, TipoProducto tipoProducto, double precioCosto, Unidad unidad,
    ...
    public Producto(int id, String nombre, String marca, TipoProducto tipoProducto, double precioCosto, Unidad unidad,
            double cantidadPorUnidad) {
        this.id = id;
        this.nombre = nombre;
        this.marca = marca;
